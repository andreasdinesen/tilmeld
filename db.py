...
def _migrate(conn: sqlite3.Connection) -> None:
    ...
    add("settings", "vapid_private", "TEXT DEFAULT ''")
    ...
    add("groups", "calendar_token", "TEXT DEFAULT ''")
    add("groups", "notify_list_enabled", "INTEGER DEFAULT 0")
    ...
    add("groups", "signup_from_members", "INTEGER DEFAULT 0")
    ...
    add("registrations", "guest_names", "TEXT DEFAULT ''")
    add("registrations", "waitlist", "INTEGER DEFAULT 0")
    add("registrations", "attended", "INTEGER DEFAULT 0")
    add("users", "name", "TEXT DEFAULT ''")
    add("users", "reset_token", "TEXT DEFAULT ''")
    add("users", "reset_expires", "TEXT DEFAULT ''")
    add("events", "waitlist_enabled", "INTEGER DEFAULT 0")
    add("events", "allow_guests", "INTEGER DEFAULT 0")
    add("events", "notify_event_reminder", "INTEGER DEFAULT 0")
    add("events", "event_reminder_sent", "INTEGER DEFAULT 0")
    add("events", "notify_list", "INTEGER DEFAULT 0")
    add("events", "notify_list_sent", "INTEGER DEFAULT 0")
    add("events", "leaders", "TEXT DEFAULT ''")
    add("events", "result_game", "TEXT DEFAULT ''")
    add("events", "result_winner", "TEXT DEFAULT ''")
    add("events", "result_legs", "INTEGER DEFAULT 0")
    add("events", "result_note", "TEXT DEFAULT ''")
